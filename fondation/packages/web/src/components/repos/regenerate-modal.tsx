...
export function RegenerateModal({ repository, isOpen, onClose, onComplete }: RegenerateModalProps) {
  ...
  const job = useQuery(api.jobs.getById, currentJobId ? { id: currentJobId } : 'skip');
          ...
          <Card className="p-4 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                <p className="text-sm font-medium">Cela va remplacer le cours existant</p>
                <p className="text-xs text-muted-foreground">
                  La génération prend généralement quelques minutes. L'ancien cours sera remplacé
                  par le nouveau.
                </p>
              </div>
            </div>
